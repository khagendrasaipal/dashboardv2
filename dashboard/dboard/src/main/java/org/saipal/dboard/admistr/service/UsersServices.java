...
import org.saipal.dboard.admistr.model.Users;
...
//			return Messenger.getMessenger().error();
	...
	public ResponseEntity<Map<String, Object>> update(String id) {
		...
		if(model.password.equals(model.cpassword)) {
			...
			rowEffect = db.execute(sql, Arrays.asList(model.fullname, model.email, new BCryptPasswordEncoder().encode(model.password), model.orgid,
					model.role,id));
