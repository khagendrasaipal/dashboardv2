...
constructor(private http: HttpClient) {}
    ...
    getListOpen(perPage: string | number, page: string | number, searchTerm?: string, sortKey?: string, sortDir?: boolean) {
        ...
        return this.http.get(this.url+"/getlistOpen" + urlPart);
