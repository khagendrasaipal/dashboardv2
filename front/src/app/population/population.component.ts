...
export class PopulationComponent implements OnInit {
  ...
  constructor(private RS: PopulationService, private toastr: ToastrService, private fb: FormBuilder) { 
    
    this.formLayout = {
      id:[],
      house_hold: ['',Validators.required],
  ...
  census:any;
  getCensus(){
    this.RS.getCensus().subscribe({
      next:(result: any) => {
        this.census = result;
        console.log(this.census);
        this.cForm.patchValue(this.census);
