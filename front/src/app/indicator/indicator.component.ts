...
export class IndicatorComponent implements OnInit {
  ...
  constructor(private RS: IndicatorService, private toastr: ToastrService, private fb: FormBuilder) { 
  ...
  cFormSubmit(){
    if (this.cForm.valid) {
      ...
      // });
      this.toastr.error('Pleasr fill all the required* fields', 'Error')
    }
  }
