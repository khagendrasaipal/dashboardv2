...
import { DashboardSetupService } from './dashboardsetup.service';

@Component({
  selector: 'app-dashboardsetup',
  templateUrl: './dashboardsetup.component.html',
  styleUrls: ['./dashboardsetup.component.scss']
})
