...
import { IndicatorValueService } from './indicatorvalue.service';

@Component({
  selector: 'app-indicatorvalue',
  templateUrl: './indicatorvalue.component.html',
  styleUrls: ['./indicatorvalue.component.scss']
})
export class IndicatorValueComponent implements OnInit {
  ...
  constructor(private RS: IndicatorValueService, private toastr: ToastrService, private fb: FormBuilder) { 
