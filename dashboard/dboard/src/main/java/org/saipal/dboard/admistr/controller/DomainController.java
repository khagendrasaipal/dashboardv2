...
import org.saipal.dboard.admistr.model.Domain;
import org.saipal.dboard.admistr.service.DomainService;
...
public class DomainController {
	...
	@Autowired
	DomainService objService;
	@PostMapping("")
	public ResponseEntity<Map<String, Object>> store(HttpServletRequest request) {
		Validator validator = validationService.validate(Domain.rules());
