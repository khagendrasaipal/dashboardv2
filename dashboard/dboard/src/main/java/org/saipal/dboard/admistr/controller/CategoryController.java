...
import org.saipal.dboard.accesscontrol.model.Permissions;
import org.saipal.dboard.admistr.model.Category;
import org.saipal.dboard.admistr.service.CategoryService;
...
public class CategoryController {
	...
	@PostMapping("/updatecensus")
	public ResponseEntity<Map<String, Object>> updatecensus(HttpServletRequest request) {
		
			return categoryService.updatecensus();
	...
	public ResponseEntity<Map<String, Object>> getCensus(HttpServletRequest request) {
		return categoryService.getCensus();
